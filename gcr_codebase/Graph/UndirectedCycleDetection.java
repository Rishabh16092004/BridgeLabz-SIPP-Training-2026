...
public class UndirectedCycleDetection {
    ...
    public static boolean hasWiringLoop(Map<Integer, List<Integer>> graph, int n) {
    ...
    public static void main(String[] args) {
        ...
        graph.put(3, Arrays.asList(2, 1)); // Creates a cycle

        System.out.println(hasWiringLoop(graph, 4));
    }
}